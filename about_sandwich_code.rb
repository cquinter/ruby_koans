...
class AboutSandwichCode < Neo::Koan
  ...
  # Chrissy's note: we are putting the lines which are repeated in count_lines and find_line above into a separate method below
  ...
  # Now we can refactor count_lines and find_line from above:
