...
class AboutMessagePassing < Neo::Koan
  ...
  # Chrissy's note: The splat operator here allows you to pass in as many arguments as you want, and it will store them in an array
  # Chrissy's note: See "ruby splat with methods" on this page: https://alexcastano.com/everything-about-ruby-splats/
