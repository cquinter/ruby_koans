...
# Chrissy's note: I didn't solidly understand all of this...never worked with regular_expressions before
# Chrissy's note: I looked this up => "Regular expressions (regexps) are patterns which describe the contents of a string. They're used for testing whether a string contains a given pattern, or extracting the portions that match."
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal nil, "abbcccddddeeeee"[/zz*/]
    assert_equal nil, "abbcccddddeeeee"[/azz*/]
    # THINK ABOUT IT:
    # When would * fail to match?
    # Chrissy's answer: There has to be a match of everything before the character next to the *.  If not, you get nil.
  end
