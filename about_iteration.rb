...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Chrissy's answer:  It takes a parameter which becomes the first argument in the block, the second argument is for the iteration. It then returns the result after the iterations are complete.
  end
  ...
  # In the previous koan, we saw the construct:
  #
  ...
  #   # code to read 'file'
  #
  # Chrissy's answer: maybe because it doesn't know when to start or stop reading from that file and what code to apply to it?
  #
